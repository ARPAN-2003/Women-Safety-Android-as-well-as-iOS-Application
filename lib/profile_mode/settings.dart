...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Future<String?> getName() async {
    try {
      ...
      var snapshot = await FirebaseFirestore.instance.collection("users").doc(auth.currentUser!.uid).get();
              ...
              FutureBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return displayName == null ? Text("Data") : Text(displayName!);
                  }
                },
              ),
                ...
                child: ListView.separated(
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        decoration: BoxDecoration(color: Colors.pinkAccent, borderRadius: BorderRadius.circular(10)), padding: EdgeInsets.all(14.0),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            Text(_infoItems[index].title!, style: TextStyle(fontSize: 18, color: Colors.white)),
